...
from GAN_model import define_generator, define_discriminator, define_composite_model, train
...
model_AtoB = load_model('g_model_AtoB_002500.h5', cust)
model_BtoA = load_model('g_model_BtoA_002500.h5', cust)

# plot A->B->A (Staellite to Map routes to Satellite)
A_real = select_sample(A_data, 1)
B_generated  = model_AtoB.predict(A_real)
A_reconstructed = model_BtoA.predict(B_generated)
show_plot(A_real, B_generated, A_reconstructed)
# plot B->A->B (Map routes to Staellite to Map routes)
...
# test_image = load_img('maps/testA/1_A.jpg')
